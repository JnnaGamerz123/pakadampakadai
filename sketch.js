...
function setup() 
{
  ...
  //GROUND
  ground=createSprite(windowWidth/2,windowHeight-10,windowWidth*2,30);

  //STEVE
  steve=createSprite(700,windowHeight-60,50,50);
...
//ZOMBIE
  zombie=createSprite(300,windowHeight-60,50,50)
...
reset.position(windowWidth-150,30);
...
drawSprites()
 ...
 function Obstacles() {
  if(frameCount % 100 === 0) {
     obstacle = createSprite(windowWidth,windowHeight-50,50,50);
     //obstacle.debug = true
